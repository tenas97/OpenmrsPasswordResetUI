 ...
 */
// generated on 2019-05-28 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'openmrspasswordresetui';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/openmrspasswordresetui`,
	  css: `${__dirname}/app/css/openmrspasswordresetui.css`,
	  vendor : [
